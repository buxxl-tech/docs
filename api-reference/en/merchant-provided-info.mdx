...
- **2. Callback URL:**
  ...
  **Details:** [Webhook Callback](/api-reference/webhook/webhook-callback)
...
- **3. Withdrawal Request Address (Optional):**
  ...
  **Details:** [Withdrawal Secondary Confirmation Callback](/api-reference/webhook/withdraw-confirmation-callback)
