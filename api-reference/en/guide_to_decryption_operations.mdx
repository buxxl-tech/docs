...
async function main() {
  try {
      ...
      console.log("Tag: " + address.getTag());
      console.log("State: " + address.getState());
      console.log("Risk score: " + address.getRiskScore());
...
def main():
  try:
      ...
      print("Tag:", address.get_tag())
      print("State:", address.get_state())
      print("Risk score:", address.get_risk_score())
